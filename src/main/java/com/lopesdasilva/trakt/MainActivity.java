...
//                getSupportFragmentManager().beginTransaction().replace(R.id.content_frame, fragment).commit();
                break;
            case 3:
                fragment = null;//getSupportFragmentManager().findFragmentByTag("calendar");
                getSupportFragmentManager().beginTransaction().replace(R.id.content_frame, new CalendarFragment(), "calendar").commit();
                break;
